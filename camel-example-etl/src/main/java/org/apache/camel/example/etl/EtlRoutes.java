...
public class EtlRoutes extends SpringRouteBuilder {
    public void configure() throws Exception {
        ...
        from("file:src/data?noop=true")//Leitet zu den Files, noop damit es nicht geloescht oder verschoben wird
            .convertBodyTo(PersonDocument.class)//Convert Body to PersonDocument
            .to("jpa:org.apache.camel.example.etl.CustomerEntity");//unmarshall object

        // the following will dump the database to files
	// senden von PersonDocument zum JPA-endpoint
